...
notify "Performing backup for M1X22"

# export env variables
export RESTIC_REPOSITORY="sftp:synology-nas:/home/backups/mac/m1x22"
...
# run backup
restic backup --tag pro2014 --tag personal $HOME/projects/personal/config --verbose
# --exclude-file=$HOME/projects/personal/config/restic/mac/m1x22/excludes
# run pruning
