...
/home/restic/bin/restic backup --tag home --tag archx /home/ --exclude-file=/home/restic/config/restic/images/archx/excludes_home --exclude-larger-than 100M --verbose
# run pruning
